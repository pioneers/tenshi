...
#define ngl_define_alien(alien_type) \
  ...
  ngl_type_alien join_token3(ngl_type_, alien_type, _inst); \
  extern ngl_type_base join_token3(ngl_type_, base_type, _inst); \
  ngl_define_ptr(alien_type)

#define ngl_init_alien(alien_type) \
  join_token(ngl_type_, alien_type) = \
      (ngl_type *) &join_token3(ngl_type_, alien_type, _inst); \
...
#define ngl_define_base(base_type) \
  ...
  ngl_type_base join_token3(ngl_type_, base_type, _inst); \
  ngl_define_ptr(base_type)

#define ngl_init_base(base_type) \
  join_token(ngl_type_, base_type) = \
      (ngl_type *) &join_token3(ngl_type_, base_type, _inst); \
...
#define ngl_declare_composite(composite_type) \
  ...
  ngl_type_composite join_token3(ngl_type_, composite_type, _inst); \
...
#define ngl_init_composite(composite_type) \
  join_token(ngl_type_, composite_type) = \
      (ngl_type *) &join_token3(ngl_type_, composite_type, _inst); \
...
#define ngl_declare_ptr(base_type) \
  ...
  extern ngl_type_pointer join_token3(ngl_type_, base_type, _ptr_inst);

#define ngl_define_ptr(base_type) \
  ngl_type * join_token3(ngl_type_, base_type, _ptr); \
  ngl_type_pointer join_token3(ngl_type_, base_type, _ptr_inst);

#define ngl_init_ptr(base_type) \
  join_token3(ngl_type_, base_type, _ptr) = \
      (ngl_type *) &join_token3(ngl_type_, base_type, _ptr_inst); \
  ...
  join_token3(ngl_type_, base_type, _ptr)->ptr_of = NULL;
