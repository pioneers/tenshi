#ifndef NGL_ARRAY_INTERNAL_H

#define NGL_ARRAY_INTERNAL_H
...
ngl_error * ngl_array_init_to_size ( ngl_array * self, ngl_type * ngl_array_elem_type, ngl_int num_elements );
...
#endif /* end of include guard: NGL_ARRAY_INTERNAL_H */
