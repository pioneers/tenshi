...
def configure(conf):
    ...
    conf.env['CXX'] = ARM_CROSS_COMPILER_C
    conf.env['CXX_NAME'] = ARM_CROSS_COMPILER_C
    conf.env['COMPILER_CXX'] = ARM_CROSS_COMPILER_C
    conf.env['LINK_CXX'] = ARM_CROSS_COMPILER_C
