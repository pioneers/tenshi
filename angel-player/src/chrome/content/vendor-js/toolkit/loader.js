...
// TODO(rqou): There appears to be a bug in the Mozilla SDK such that trying
// to load the loader using require does not actually work. The following line
// has been "fixed" such that now it only works via require and does not work
// normally. However, this is fine because this copy of loader.js will only be
// picked up via require anyways.
// const { classes: Cc, Constructor: CC, interfaces: Ci, utils: Cu,
//         results: Cr, manager: Cm } = Components;
const { Cc: Cc, CC: CC, Ci: Ci, Cu: Cu, Cr: Cr, Cm: Cm, Components: components,
        ChromeWorker: ChromeWorker } = require('chrome');
